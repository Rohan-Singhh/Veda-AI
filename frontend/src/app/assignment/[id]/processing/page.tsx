...
const STEPS = [
  {
    ...
    desc: "Reading your topic, question types and preferences",
    icon: (
  ...
  },
  {
    ...
    desc: "AI is crafting high-quality questions for each section",
    icon: (
      <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Formatting paper",
    desc: "Structuring sections, marks and difficulty levels",
    icon: (
      <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function ProcessingPage({ params }: ProcessingPageProps) {
  ...
  useEffect(() => {
    ...
    socket.on("assignment:completed", (data: { paper: any }) => {
